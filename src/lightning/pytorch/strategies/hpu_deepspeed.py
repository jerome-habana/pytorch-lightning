...
_HPU_DEEPSPEED_AVAILABLE = (
    ...
    RequirementCache("deepspeed>=0.7.0") #TBD - jerome check right version  0.7.0+e36c1b6
)
...
class HPUDeepSpeedStrategy(HPUParallelStrategy):
    ...
    def __init__(
        ...
        if self.config is None:
            ...
            self.config = self._create_default_config( #jerome get def values
                zero_optimization,
    ...
    def register_strategies(cls, strategy_registry: Dict) -> None:
        ...
        strategy_registry.register("hpu_deepspeed_stage_1", cls, description="DeepSpeed with ZeRO Stage 1 enabled", stage=1)
        strategy_registry.register("hpu_deepspeed_stage_2", cls, description="DeepSpeed with ZeRO Stage 2 enabled", stage=2)
